        ...
        <form onSubmit={submit} className="space-y-2 p-3 text-[12px]">
          ...
          <div className="flex items-center gap-2 pt-2">
            <button
              type="submit"
              disabled={busy}
              className="grid h-6 min-w-[80px] place-items-center border border-[var(--color-border-strong)] bg-[var(--grad-btn)] px-3 text-[12px] hover:bg-[var(--grad-btn-hover)] disabled:opacity-50"
            >
              {busy ? (
